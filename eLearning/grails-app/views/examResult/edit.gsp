...
<body>
<z:window style="padding:5px" apply="com.cland.elearning.examresult.EditComposer">
    <z:longbox name="id" value="${examResultInstance.id}" visible="false"/>
    <z:longbox name="version" value="${examResultInstance.version}" visible="false"/>
