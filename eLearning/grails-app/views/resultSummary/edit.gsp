...
<body>
<z:window style="padding:5px" apply="com.cland.elearning.resultsummary.EditComposer">
    <z:longbox name="id" value="${resultSummaryInstance.id}" visible="false"/>
    <z:longbox name="version" value="${resultSummaryInstance.version}" visible="false"/>
