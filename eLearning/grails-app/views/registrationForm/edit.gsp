...
<html>
	...
	<body>
		<a href="#edit-registrationForm" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-registrationForm" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${registrationFormInstance?.version}" />
				<fieldset class="form">
