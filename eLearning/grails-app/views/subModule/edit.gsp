...
<body>
<z:window style="padding:5px" apply="com.cland.elearning.submodule.EditComposer">
    <z:longbox name="id" value="${subModuleInstance.id}" visible="false"/>
    <z:longbox name="version" value="${subModuleInstance.version}" visible="false"/>
