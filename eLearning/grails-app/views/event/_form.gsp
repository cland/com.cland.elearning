...
<div id="recurOptions" style="display:none" >
    ...
    <div><label>Ends:</label>
        <div class="input">
            ...
            <label for="recurEndOption3">On <g:textField name="recurUntil" size="8" value="${formatDate(date: (eventInstance?.recurCount ? null : eventInstance?.recurUntil), format: 'dd/MM/yyyy hh:mm a')}" /></label>
