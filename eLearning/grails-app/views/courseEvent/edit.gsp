...
<body>
<z:window style="padding:5px" apply="com.cland.elearning.courseevent.EditComposer">
    <z:longbox name="id" value="${courseEventInstance.id}" visible="false"/>
    <z:longbox name="version" value="${courseEventInstance.version}" visible="false"/>
