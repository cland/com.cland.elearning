...
<body>
<z:window style="padding:5px" apply="com.cland.elearning.venue.EditComposer">
    <z:longbox name="id" value="${venueInstance.id}" visible="false"/>
    <z:longbox name="version" value="${venueInstance.version}" visible="false"/>
