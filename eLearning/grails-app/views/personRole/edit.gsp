...
<body>
<z:window style="padding:5px" apply="com.cland.elearning.personrole.EditComposer">
    <z:longbox name="id" value="${personRoleInstance.id}" visible="false"/>
    <z:longbox name="version" value="${personRoleInstance.version}" visible="false"/>
