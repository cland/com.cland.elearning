<html>
    ...
    <body>
        <z:window style="padding:5px" apply="com.cland.elearning.personrole.ListComposer">
            <z:hlayout>
                ...
                <z:space/>
                <z:label value="${message(code:'personRole.id',default:'Id')}"/>
            ...
            <z:grid id="grid" emptyMessage="${message(code:'emptyMessage',default:'No Record')}">
                <z:columns sizable="true">
                    <z:column label="${message(code: 'personRole.id.label', default: 'Id')}"/>
                    <z:column label="${message(code: 'personRole.person.label', default: 'Person')}"/>
                    <z:column label="${message(code: 'personRole.role.label', default: 'Role')}"/>
