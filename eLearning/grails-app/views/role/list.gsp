<html>
    ...
    <body>
        <z:window style="padding:5px" apply="com.cland.elearning.role.ListComposer">
            <z:hlayout>
                ...
                <z:space/>
                <z:label value="${message(code:'role.id',default:'Id')}"/>
            ...
            <z:grid id="grid" emptyMessage="${message(code:'emptyMessage',default:'No Record')}">
                <z:columns sizable="true">
                    <z:column label="${message(code: 'role.id.label', default: 'Id')}"/>
                    <z:column label="${message(code: 'role.authority.label', default: 'Authority')}"/>
