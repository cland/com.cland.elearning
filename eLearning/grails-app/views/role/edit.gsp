...
<body>
<z:window style="padding:5px" apply="com.cland.elearning.role.EditComposer">
    <z:longbox name="id" value="${roleInstance.id}" visible="false"/>
    <z:longbox name="version" value="${roleInstance.version}" visible="false"/>
