...
<body>
<z:window style="padding:5px" apply="com.cland.elearning.region.EditComposer">
    <z:longbox name="id" value="${regionInstance.id}" visible="false"/>
    <z:longbox name="version" value="${regionInstance.version}" visible="false"/>
