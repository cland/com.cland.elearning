...
<body>
<z:window style="padding:5px" apply="com.cland.elearning.country.EditComposer">
    <z:longbox name="id" value="${countryInstance.id}" visible="false"/>
    <z:longbox name="version" value="${countryInstance.version}" visible="false"/>
