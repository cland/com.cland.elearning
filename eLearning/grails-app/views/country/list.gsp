<html>
    ...
    <body>
        <z:window style="padding:5px" apply="com.cland.elearning.country.ListComposer">
            <z:hlayout>
                ...
                <z:space/>
                <z:label value="${message(code:'country.id',default:'Id')}"/>
            ...
            <z:grid id="grid" emptyMessage="${message(code:'emptyMessage',default:'No Record')}">
                <z:columns sizable="true">
                    <z:column label="${message(code: 'country.id.label', default: 'Id')}"/>
                    <z:column label="${message(code: 'country.name.label', default: 'Name')}"/>
