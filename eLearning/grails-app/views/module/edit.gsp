...
<body>
<z:window style="padding:5px" apply="com.cland.elearning.module.EditComposer">
    <z:longbox name="id" value="${moduleInstance.id}" visible="false"/>
    <z:longbox name="version" value="${moduleInstance.version}" visible="false"/>
