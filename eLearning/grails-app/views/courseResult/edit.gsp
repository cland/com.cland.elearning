...
<body>
<z:window style="padding:5px" apply="com.cland.elearning.courseresult.EditComposer">
    <z:longbox name="id" value="${courseResultInstance.id}" visible="false"/>
    <z:longbox name="version" value="${courseResultInstance.version}" visible="false"/>
