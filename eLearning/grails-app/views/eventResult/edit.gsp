...
<body>
<z:window style="padding:5px" apply="com.cland.elearning.eventresult.EditComposer">
    <z:longbox name="id" value="${eventResultInstance.id}" visible="false"/>
    <z:longbox name="version" value="${eventResultInstance.version}" visible="false"/>
